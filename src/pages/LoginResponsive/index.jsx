...
const LoginResponsivePage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter sm:gap-10 md:gap-10 gap-[262px] items-center justify-start mx-auto pb-[349px] w-full">
...
export default LoginResponsivePage;
